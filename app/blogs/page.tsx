...
export default async function BlogsPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0b0b0e", color: "#f3f3f3", fontFamily: "JetBrains Mono, monospace" }}>
      <div className="mx-auto min-h-screen w-full max-w-4xl px-6 py-10 sm:px-10">
        ...
        <header className="max-w-2xl pt-14">
          ...
          <h1 style={{ fontSize: "clamp(2.25rem, 5vw, 3.75rem)", lineHeight: "1.05", fontFamily: "Instrument Serif, serif", margin: "0 0 20px" }}>
            Blogs
          </h1>
        ...
        <footer style={{ marginTop: "42px", textAlign: "center", color: "#9ca3af", fontSize: "0.95rem" }}>
          ...
          <br />
          <span><a href="/" style={{ color: "#9ca3af", textDecoration: "none" }}>← Back to portfolio</a> · <a href="#" style={{ color: "#9ca3af", textDecoration: "none" }}>source</a> · <a href="#" style={{ color: "#9ca3af", textDecoration: "none" }}>pgp</a> · <a href="#" style={{ color: "#9ca3af", textDecoration: "none" }}>rss</a></span>
        </footer>
      </div>
    </main>
  );
